...
<head>
    ...
    <!-- 引入http://admin.shop.com/Public/Admin/treegrid1的css-->
    <link href="http://admin.shop.com/Public/Admin/treegrid1/css/jquery.treegrid.css" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript" src="http://admin.shop.com/Public/Admin/js/common.js"></script>
    ...
    <!-- 引入http://admin.shop.com/Public/Admin/treegrid1的js-->
    <script type="text/javascript" src="http://admin.shop.com/Public/Admin/treegrid1/js/jquery.treegrid.js"></script>
